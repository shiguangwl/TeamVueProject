    ...
    >
      <div
        class="
                        ...
                        relative
                    "
        style="background-image: url('https://www.17sucai.com/preview/776298/2021-08-21/dlll/img/img.jpg')"
      >
        <div
          class="
                            absolute
        ...
        <div class="max-w-md w-full mx-auto space-y-8">
          ...
          <form class="mt-8 space-y-6">
            ...
            <div class="w-4/12" style="display: inline-block;height: 30px;">
              <img :src="captchaURL+data.uuid" alt="" @click="updateUUID()">
            </div>
            ...
            <div>
              <input type="button" value="登录" @click="loginFun()" class="
                     w-full
                     flex
                     justify-center
                     bg-gradient-to-r
...
export default defineComponent({
  ...
  setup () {
    ...
    const loginFun = async () => {
      const { data: res } = await UserApi.Login(state.data)
      if (res.code === 0) {
...
<!--<style scoped ">-->
<style scoped src="@/assets/css/tailwind.min.css">
.circles {
  position: absolute;
  top: 0;
  left: 0;
